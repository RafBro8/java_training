...
public class WhileChallenge {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of digits in number -235 is " + sumDigits(-235));
        System.out.println("Sum of digits in number 8 is " + sumDigits(8));
        System.out.println("Sum of digits in number 8555 is " + sumDigits(8555));
